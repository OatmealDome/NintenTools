namespace Vibeware.NintenTools.Bfres
{
    ...
    using System.IO;
    using Vibeware.NintenTools.Bfres.Embedded;
    using Vibeware.NintenTools.Bfres.Fmdl;
    using Vibeware.NintenTools.Bfres.Fscn;
    using Vibeware.NintenTools.Bfres.Fsha;
    using Vibeware.NintenTools.Bfres.Fshu;
    using Vibeware.NintenTools.Bfres.Fska;
    using Vibeware.NintenTools.Bfres.Ftex;
    using Vibeware.NintenTools.Bfres.Ftxp;
    using Vibeware.NintenTools.Bfres.Fvis;
